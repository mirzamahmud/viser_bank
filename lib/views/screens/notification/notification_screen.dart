...
import 'package:viser_bank/data/controller/notifications/notification_controller.dart';
import 'package:viser_bank/data/repo/notification_repo/notification_repo.dart';
...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<NotificationsController>(builder: (controller)=>SafeArea(
      child: Scaffold(
        backgroundColor: MyColor.containerBgColor,
        appBar: const CustomAppBar(title: MyStrings.notification),
             ...
             return  GestureDetector(
               ...
               child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: controller.notificationList[index].view.toString()=='1'?MyColor.colorWhite:MyColor.primaryColor.withOpacity(.05),
