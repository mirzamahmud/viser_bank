...
import 'package:viser_bank/views/components/checkbox/custom_check_box.dart';
import 'package:viser_bank/views/components/custom_loader.dart';
import 'package:viser_bank/views/components/custom_radio_button.dart';
...
import 'package:viser_bank/views/screens/withdraw/confirm_withdraw_screen/widget/choose_file_list_item.dart';
    ...
    return GetBuilder<KycController>(
      builder: (controller) =>
          Scaffold(
            ...
            appBar: const CustomAppBar(title: MyStrings.kyc),
            body: SizedBox(
                height: MediaQuery.of(context).size.height,
                width: MediaQuery.of(context).size.width,
                child: controller.isLoading? const Padding(padding:EdgeInsets.all(Dimensions.paddingSize15),child:CustomLoader()):controller.isAlreadyVerified?const AlreadyVerifiedWidget():controller.isAlreadyPending?const AlreadyVerifiedWidget(isPending: true,):controller.isNoDataFound?  const NoDataFoundScreen():Center(
